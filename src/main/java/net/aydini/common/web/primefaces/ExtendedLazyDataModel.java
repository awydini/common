package net.aydini.common.web.primefaces;
...
public abstract class ExtendedLazyDataModel<E extends BaseEntityModel> extends LazyDataModel<E> {
    ...
    public List<E> load(Integer first, Integer pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
    ...
    public E getRowData(String rowKey) {
        List<E> res = (List<E>)this.getWrappedData();
        List<E> wrappedData = new ArrayList<>(res);
        Iterator<E> var4 = wrappedData.iterator();
